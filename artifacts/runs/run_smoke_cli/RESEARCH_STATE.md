...
## Header
- run_id: run_smoke_cli
- created_at: 2026-02-01T08:09:13.303402+00:00
- last_updated: 2026-02-01T08:09:13.303402+00:00
- question:
  ```md
  Derive the non-relativistic limit of the Dirac equation.
  
  Assume $c\to\infty$ and show how the Pauli equation emerges.
  ```
- config_snapshot:
```yaml
models:
...
## History log
- 2026-02-01T08:09:13.303402+00:00: init run
